	            ...
	            <% }else{ %>
	                ...
	                <% } %>
	                    <form action="login" method="post" class="form1">
	                        ...
	                        <p class="forgot " align="center"><a href="forgotPassword" class="ahover">Forgot Password?</a>
	                        </p>
	                        <p class="newuser " align="center"><a href="register" class="ahover">New to iShip? Register</a>
	                        </p>
	                    </form>
	    </div>
	</body>
